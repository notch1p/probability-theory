...
\setCJKmainfont[ItalicFont=LXGW WenKai Mono GB, BoldFont=Sarasa Gothic SC Bold]{BabelStone Han}
\setCJKmonofont{Sarasa Fixed Slab SC}
\setCJKsansfont{Sarasa Gothic SC}
\setCJKmathfont{BabelStone Han}
\setCJKfamilyfont{jarm}{IPAmjMincho}[BoldFont=Sarasa Gothic J Bold, ItalicFont=YuKyokasho]
\setCJKfamilyfont{hant}{I.Ming}[BoldFont=Sarasa Gothic CL Bold, ItalicFont=LXGW WenKai Mono TC]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[tmargin=2cm,rmargin=1in,lmargin=1in,margin=1.2in,bmargin=2cm,footskip=.2in]{geometry}
...
\setmathfont{XCharter-Math.otf}[Scale=1.1,BoldFont=XCharter-Math-Bold.otf, CharacterVariant={3,6,10}, StylisticSet=4]
\setmathfont{Libertinus Math}[range="1D4B6-"1D4CF, Scale=MatchLowercase]
\newfontfamily\displayfont{Literata 72pt ExtraBold Italic}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

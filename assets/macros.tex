...
\newcommand{\sol}{\setlength{\parindent}{0cm}\textsf{\bfseries Solution:}\setlength{\parindent}{1cm} }
\newcommand{\solve}[1]{\setlength{\parindent}{0cm}\textsf{\bfseries Solution:}\setlength{\parindent}{1cm}#1 \Qed}

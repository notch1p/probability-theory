...
\begin{figure}[h]
    \centering
    \includegraphics[scale=.75]{Normal_Distribution_PDF}
    \caption{PDF}
\end{figure}
...
那么有\\
\begin{equation}
    \Pr{Y=y_i} = \Pr{X\in C_i } = \sum_{x_j \in C_i }\Pr{X=x_j}
\end{equation}
...
\sol{
    由题意得$Y=0,1,4,9,$
    \begin{align*}
        \Pr{Y=0} & = \Pr{X=0} = \frac{1}{5}              \\
        \Pr{Y=1} & = \Pr{X=-1} + \Pr{X=1} = \frac{7}{30} \\
        \Pr{Y=4} & = \Pr{X=-2} + \Pr{X=2} = \frac{1}{5}  \\
        \Pr{Y=9} & = \Pr{X=3} = \frac{11}{30}
    \end{align*}
    \begin{center}
        $\tf$\;
...
\sol{
    ...
    \begin{align*}
        F_Y(y ) = \Pr{2X^2 +1 \leq y} & = \Pr{\sqrt{-\frac{y-1}{2}}\leq X \leq \sqrt{\frac{y-1}{2}}}                                                                                                                                                    \\
                                      & =\begin{cases*}
                                             {\left(\displaystyle\int_{-\sqrt{\frac{y-1}{2}}}^{\sqrt{\frac{y-1}{2}}}f_X(x )\dd x\right)'} & $y> 1$ \\
                                             0                                                                                            & else
                                         \end{cases*}                                                                                                          \\
                                      & = \begin{cases*}
    ...
    \end{align*}
    \begin{equation*}
        \bc\; \phi(x ) = \frac{1}{\sqrt{2\pi}}e^{-\frac{x^2}{2}}\;\;\mbox{注意到$\phi(x)$为偶函数}
    \end{equation*}
    Therefore we have
    \begin{align*}
        f_Y(y ) = \begin{cases*}
